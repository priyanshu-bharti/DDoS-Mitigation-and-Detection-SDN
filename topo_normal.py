...
TEST_TIME = 1000 #seconds
TEST_TYPE = "normal"
#normal, attack, manual

class MultiSwitchTopo(Topo):
    "3 Switches connected to 10 hosts."
    def build(self):
        ...
        self.addLink(h2, s1, cls=TCLink, bw=1)
        self.addLink(h3, s1, cls=TCLink, bw=1)
        self.addLink(h4, s1, cls=TCLink, bw=1)
        self.addLink(h5, s1, cls=TCLink, bw=1)
        self.addLink(h6, s1, cls=TCLink, bw=1)
        self.addLink(h7, s1, cls=TCLink, bw=1)
        self.addLink(h8, s1, cls=TCLink, bw=1)
        self.addLink(h9, s1, cls=TCLink, bw=1)
        self.addLink(h10, s1, cls=TCLink, bw=1)

        self.addLink(h1, s2, cls=TCLink, bw=1)
        self.addLink(h2, s2, cls=TCLink, bw=1)
        self.addLink(h3, s2, cls=TCLink, bw=1)
        self.addLink(h4, s2, cls=TCLink, bw=1)
        self.addLink(h5, s2, cls=TCLink, bw=1)
        self.addLink(h6, s2, cls=TCLink, bw=1)
        self.addLink(h7, s2, cls=TCLink, bw=1)
        self.addLink(h8, s2, cls=TCLink, bw=1)
        self.addLink(h9, s2, cls=TCLink, bw=1)
        self.addLink(h10, s2, cls=TCLink, bw=1)

        # self.addLink(h1, s3, cls=TCLink, bw=1)
        # self.addLink(h2, s3, cls=TCLink, bw=1)
        # self.addLink(h3, s3, cls=TCLink, bw=1)
        # self.addLink(h4, s3, cls=TCLink, bw=1)
        # self.addLink(h5, s3, cls=TCLink, bw=1)
        # self.addLink(h6, s3, cls=TCLink, bw=1)
        # self.addLink(h7, s3, cls=TCLink, bw=1)
        # self.addLink(h8, s3, cls=TCLink, bw=1)
        # self.addLink(h9, s3, cls=TCLink, bw=1)
        # self.addLink(h10, s3, cls=TCLink, bw=1)
